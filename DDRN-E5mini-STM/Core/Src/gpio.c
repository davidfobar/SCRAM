...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, Bias_CS_Pin|Env_Sens_Enable_Pin|Bias_Enable_Pin|Stim_Enable_Pin
  ...
  GPIO_InitStruct.Pin = Bias_CS_Pin|Env_Sens_Enable_Pin|Bias_Enable_Pin|Stim_Enable_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
